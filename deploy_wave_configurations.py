...
# execution
    ...
    output_file.write("###################################################################################################################" + "\n")
    output_file.write("\n")
    output_file.write("### Clear Cache nssoTask" + "\n")
    output_file.write("POST {{baseUrl}}/cachingNssoBusinessProcess/clearCaches HTTP/1.1" + "\n")
    output_file.write("content-type: application/json" + "\n")
    output_file.write("Authorization: {{bearerToken}} " + "\n")
    output_file.write("Cache-Control: no-cache" + "\n")
    output_file.write("\n")
    output_file.write("### Clear Cache DocMgt" + "\n")
    output_file.write("POST {{baseUrl}}/cachingNssoDocument/clearCaches HTTP/1.1" + "\n")
    output_file.write("content-type: application/json" + "\n")
    output_file.write("Authorization: {{bearerToken}} " + "\n")
    output_file.write("Cache-Control: no-cache" + "\n")
    output_file.write("\n")
    output_file.write("### Clear Cache WOGateway" + "\n")
    output_file.write("POST {{baseUrl}}/cachingWorkEnvironmentGateway/clearCaches HTTP/1.1" + "\n")
    output_file.write("content-type: application/json" + "\n")
    output_file.write("Authorization: {{bearerToken}} " + "\n")
    output_file.write("Cache-Control: no-cache" + "\n")